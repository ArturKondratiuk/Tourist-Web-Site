console.log("Tokyo Explorer page loaded.");
...
function getFakeWeatherForecast(city) {
  const cityForecasts = {
    "Tokyo": [
      { day: "Monday", temp: 21, desc: "🌤️ Sunny intervals" },
      { day: "Tuesday", temp: 23, desc: "☀️ Sunny" },
      { day: "Wednesday", temp: 22, desc: "🌦️ Showers" },
      { day: "Thursday", temp: 20, desc: "🌤️ Partly sunny" },

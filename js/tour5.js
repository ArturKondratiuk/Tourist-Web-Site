console.log("Greek iseland Cruise page loaded.");
...
function getFakeWeatherForecast(city) {
  const cityForecasts = {
    "Athens": [
      { day: "Monday", temp: 27, desc: "☀️ Sunny" },
      { day: "Tuesday", temp: 29, desc: "☀️ Hot" },
      { day: "Wednesday", temp: 28, desc: "☀️ Sunny" },
      { day: "Thursday", temp: 26, desc: "🌤️ Partly sunny" },
      { day: "Friday", temp: 30, desc: "☀️ Very hot" }
    ],
  };
